!function (e) {
	...
	!function (i) {
		"use strict";
		var o = document, a = "getElementsByClassName", s = function (e) {
		...
		}, l = 0, d = ["layui-m-layer"], p = function (e) {
			this.config = u.extend(e), this.view();
		};
		p.prototype.view = function () {
			var e = this, t = e.config, n = o.createElement("div");
			...
			v: "2.0", index: l, open: function (e) {
				...
				for (var e = o[a](d[0]), t = 0, n = e.length; n > t; t++) {
	...
	!function (t, n) {
		...
		"use strict";
		var o = [], a = n.document, s = Object.getPrototypeOf, c = o.slice, u = o.concat, l = o.push, d = o.indexOf,
			p = {}, f = p.toString, h = p.hasOwnProperty, m = h.toString, g = m.call(Object), y = {}, v = function (e) {
		...
		E.fn = E.prototype = {
			...
			for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || v(a) || (a = {}), s === c && (a = this, s--); s < c; s++) {
				if (null != (e = arguments[s])) {
					for (t in e) {
						r = e[t], "__proto__" !== t && a !== r && (u && r && (E.isPlainObject(r) || (i = Array.isArray(r))) ? (n = a[t], o = i && !Array.isArray(n) ? [] : i || E.isPlainObject(n) ? n : {}, i = !1, a[t] = E.extend(u, o, r)) : void 0 !== r && (a[t] = r));
					}
				}
			}
			return a;
		...
		var k = function (e) {
			var t, n, r, i, o, a, s, c, u, l, d, p, f, h, m, g, y, v, x, A = "sizzle" + 1 * new Date, b = e.document,
				w = 0, T = 0, E = ce(), S = ce(), C = ce(), k = ce(), R = function (e, t) {
					return e === t && (d = !0), 0;
				}, L = {}.hasOwnProperty, O = [], N = O.pop, M = O.push, B = O.push, P = O.slice, I = function (e, t) {
				...
				F = "\\[" + U + "*(" + j + ")(?:" + U + "*([*^$|!~]?=)" + U + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + j + "))|)" + U + "*\\]",
				_ = ":(" + j + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)",
				H = new RegExp(U + "+", "g"), q = new RegExp("^" + U + "+|((?:^|[^\\\\])(?:\\\\.)*)" + U + "+$", "g"),
				G = new RegExp("^" + U + "*," + U + "*"), K = new RegExp("^" + U + "*([>+~]|" + U + ")" + U + "*"),
				X = new RegExp(U + "|>"), V = new RegExp(_), W = new RegExp("^" + j + "$"), z = {
					ID: new RegExp("^#(" + j + ")"),
					CLASS: new RegExp("^\\.(" + j + ")"),
					TAG: new RegExp("^(" + j + "|[*])"),
					ATTR: new RegExp("^" + F),
				...
				}, Q = /HTML$/i, Y = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, Z = /^[^{]+\{\s*\[native \w/,
				$ = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/,
				te = new RegExp("\\\\([\\da-f]{1,6}" + U + "?|(" + U + ")|.)", "ig"), ne = function (e, t, n) {
					var r = "0x" + t - 65536;
			...
			function se(e, t, r, i) {
				var o, s, u, l, d, h, y, v = t && t.ownerDocument, w = t ? t.nodeType : 9;
				...
				if (!i && ((t ? t.ownerDocument || t : b) !== f && p(t), t = t || f, m)) {
					if (11 !== w && (d = $.exec(e))) {
						if (o = d[1]) {
							...
							} else if (v && (u = v.getElementById(o)) && x(t, u) && u.id === o) {
								return r.push(u), r;
							}
						} else {
							if (d[2]) {
							...
							if ((o = d[3]) && n.getElementsByClassName && t.getElementsByClassName) {
								return B.apply(r, t.getElementsByClassName(o)), r;
							}
						}
					}
					if (n.qsa && !k[e + " "] && (!g || !g.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
						if (y = e, v = t, 1 === w && X.test(e)) {
							for ((l = t.getAttribute("id")) ? l = l.replace(re, ie) : t.setAttribute("id", l = A), s = (h = a(e)).length; s--;) {
								h[s] = "#" + l + " " + xe(h[s]);
							}
			...
			for (t in n = se.support = {}, o = se.isXML = function (e) {
				...
				return a !== f && 9 === a.nodeType && a.documentElement && (h = (f = a).documentElement, m = !o(f), b !== f && (i = f.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", oe, !1) : i.attachEvent && i.attachEvent("onunload", oe)), n.attributes = le(function (e) {
					...
					if (!i || !o) {
						return e === f ? -1 : t === f ? 1 : i ? -1 : o ? 1 : l ? I(l, e) - I(l, t) : 0;
					}
					if (i === o) {
						return pe(e, t);
					}
				...
				if ((e.ownerDocument || e) !== f && p(e), n.matchesSelector && m && !k[t + " "] && (!y || !y.test(t)) && (!g || !g.test(t))) {
					try {
						var r = v.call(e, t);
				...
				filter: {
					TAG: function (e) {
						...
						return 1 === r && 0 === i ? function (e) {
							...
							var u, l, d, p, f, h, m = o !== a ? "nextSibling" : "previousSibling", g = t.parentNode,
							...
							if (g) {
								...
								if (h = [a ? g.firstChild : g.lastChild], a && v) {
									...
									for (; (p = ++f && p && p[m] || (x = f = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++x || (v && ((l = (d = p[A] || (p[A] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] = [w, x]), p !== t));) {
										;
									}
								}
			...
			function Ae(e, t, n) {
				...
				return t.first ? function (t, n, i) {
					...
					if (c) {
						...
						for (; t = t[r];) {
							if (1 === t.nodeType || a) {
								if (l = (d = t[A] || (t[A] = {}))[t.uniqueID] || (d[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) {
									t = t[r] || t;
								} else {
									if ((u = l[o]) && u[0] === w && u[1] === s) {
										return p[2] = u[2];
									}
									if ((l[o] = p)[2] = e(t, n, c)) {
										return !0;
			...
			function Te(e, t, n, r, i, o) {
				return r && !r[A] && (r = Te(r)), i && !i[A] && (i = Te(i, o)), ue(function (o, a, s, c) {
					var u, l, d, p = [], f = [], h = a.length, m = o || function (e, t, n) {
							for (var r = 0, i = t.length; r < i; r++) {
								se(e, t[r], n);
							}
							return n;
						}(t || "*", s.nodeType ? [s] : s, []), g = !e || !o && t ? m : we(m, p, e, s, c),
						y = n ? i || (o ? e : h || r) ? [] : a : g;
					if (n && n(g, y, s, c), r) {
						for (u = we(y, f), r(u, [], s, c), l = u.length; l--;) {
							(d = u[l]) && (y[f[l]] = !(g[f[l]] = d));
						}
					}
					if (o) {
						if (i || e) {
							...
							for (l = y.length; l--;) {
								(d = y[l]) && -1 < (u = i ? I(o, d) : p[l]) && (o[u] = !(a[u] = d));
							}
						}
					} else {
						y = we(y === a ? y.splice(h, y.length) : y), i ? i(null, a, y, c) : B.apply(a, y);
					}
				});
			}
			...
			function Ee(e) {
				for (
					var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], c = a ? 1 : 0, l = Ae(function (e) {
						return e === t;
					}, s, !0), d = Ae(function (e) {
						return -1 < I(t, e);
					...
					if (n = r.relative[e[c].type]) {
						...
						if ((n = r.filter[e[c].type].apply(null, e[c].matches))[A]) {
							...
							return Te(1 < c && be(p), 1 < c && xe(e.slice(0, c - 1).concat({value: " " === e[c - 2].type ? "*" : ""})).replace(q, "$1"), n, c < i && Ee(e.slice(c, i)), i < o && Ee(e = e.slice(i)), i < o && xe(e));
						}
						p.push(n);
					}
				}
			...
			return ve.prototype = r.filters = r.pseudos, r.setFilters = new ve, a = se.tokenize = function (e, t) {
				...
				for (s = e, c = [], u = r.preFilter; s;) {
					for (a in n && !(i = G.exec(s)) || (i && (s = s.slice(i[0].length) || s), c.push(o = [])), n = !1, (i = K.exec(s)) && (n = i.shift(), o.push({
						...
						!(i = z[a].exec(s)) || u[a] && !(i = u[a](i)) || (n = i.shift(), o.push({
							value: n,
							type: a,
							matches: i,
						}), s = s.slice(n.length));
				...
				var n, i, o, s, c, l, d = [], h = [], g = C[e + " "];
				if (!g) {
					for (t || (t = a(e)), n = t.length; n--;) {
						(g = Ee(t[n]))[A] ? d.push(g) : h.push(g);
					}
					(g = C(e, (i = h, s = 0 < (o = d).length, c = 0 < i.length, l = function (e, t, n, a, l) {
						var d, h, g, y = 0, v = "0", x = e && [], A = [], b = u, T = e || c && r.find.TAG("*", l),
							E = w += null == b ? 1 : Math.random() || .1, S = T.length;
				...
				var o, c, u, l, d, p = "function" == typeof e && e, f = !i && a(e = p.selector || e);
				if (n = n || [], 1 === f.length) {
		...
		var D = /^(?:parents|prev(?:Until|All))/, U = {children: !0, contents: !0, next: !0, prev: !0};
		...
		E.Callbacks = function (e) {
			...
			var r, i, o, a, s = [], c = [], u = -1, l = function () {
				for (a = a || e.once, o = r = !0; c.length; u = -1) {
					for (i = c.shift(); ++u < s.length;) {
						!1 === s[u].apply(i[0], i[1]) && e.stopOnFalse && (u = s.length, i = !1);
					}
				}
			...
			Deferred: function (e) {
				...
				var t = arguments.length, n = t, r = Array(n), i = c.call(arguments), o = E.Deferred(),
					a = function (e) {
						return function (n) {
							r[e] = this, i[e] = 1 < arguments.length ? c.call(arguments) : n, --t || o.resolveWith(r, i);
						};
					};
				if (t <= 1 && (q(e, o.done(a(n)).resolve, o.reject, !t), "pending" === o.state() || v(i[n] && i[n].then))) {
					return o.then();
				}
				for (; n--;) {
					q(i[n], a(n), o.reject);
		...
		var $ = new Z, ee = new Z, te = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, ne = /[A-Z]/g;
		...
		E.extend({
			...
			data: function (e, t) {
				...
				if (void 0 === e) {
					if (this.length && (i = ee.get(o), 1 === o.nodeType && !$.get(o, "hasDataAttrs"))) {
						for (n = a.length; n--;) {
							a[n] && 0 === (r = a[n].name).indexOf("data-") && (r = Y(r.slice(5)), re(o, r, i[r]));
						}
				...
				return "object" == typeof e ? this.each(function () {
					...
					var n;
					if (o && void 0 === t) {
						return void 0 !== (n = ee.get(o, e)) ? n : void 0 !== (n = re(o, e)) ? n : void 0;
					}
					this.each(function () {
						ee.set(this, e, t);
					});
			...
			queue: function (e, t, n) {
				var r;
				if (e) {
					return t = (t || "fx") + "queue", r = $.get(e, t), n && (!r || Array.isArray(n) ? r = $.access(e, t, E.makeArray(n)) : r.push(n)), r || [];
				}
			...
			queue: function (e, t) {
				...
				for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--;) {
					(n = $.get(o[a], e + "queueHooks")) && n.empty && (r++, n.empty.add(s));
				}
				return s(), i.promise(t);
			},
		});
		var ie = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
			oe = new RegExp("^(?:([+-])=|)(" + ie + ")([a-z%]*)$", "i"), ae = ["Top", "Right", "Bottom", "Left"],
			se = a.documentElement, ce = function (e) {
		...
		function he(e, t) {
			for (var n, r, i, o, a, s, c, u = [], l = 0, d = e.length; l < d; l++) {
				(r = e[l]).style && (n = r.style.display, t ? ("none" === n && (u[l] = $.get(r, "display") || null, u[l] || (r.style.display = "")), "" === r.style.display && le(r) && (u[l] = (c = a = o = void 0, a = (i = r).ownerDocument, s = i.nodeName, (c = fe[s]) || (o = a.body.appendChild(a.createElement(s)), c = E.css(o, "display"), o.parentNode.removeChild(o), "none" === c && (c = "block"), fe[s] = c)))) : "none" !== n && (u[l] = "none", $.set(r, "display", n)));
			}
			for (l = 0; l < d; l++) {
		...
		var me = /^(?:checkbox|radio)$/i, ge = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i,
			ye = /^$|^module$|\/(?:java|ecma)script/i, ve = {
			...
			for (var o, a, s, c, u, l, d = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++) {
				if ((o = e[f]) || 0 === o) {
					if ("object" === w(o)) {
						...
						for (a = a || d.appendChild(t.createElement("div")), s = (ge.exec(o) || ["", ""])[1].toLowerCase(), c = ve[s] || ve._default, a.innerHTML = c[1] + E.htmlPrefilter(o) + c[2], l = c[0]; l--;) {
							a = a.lastChild;
						}
		...
		var Se = /^key/, Ce = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, ke = /^([^.]*)(?:\.(.+)|)/;
			...
			n ? ($.set(e, t, !1), E.event.add(e, t, {
				namespace: !1, handler: function (e) {
					...
					if (1 & e.isTrigger && this[t]) {
						...
						} else if (o = c.call(arguments), $.set(this, t, o), r = n(this, t), this[t](), o !== (i = $.get(this, t)) || r ? $.set(this, t, !1) : i = {}, o !== i) {
							return e.stopImmediatePropagation(), e.preventDefault(), i.value;
						}
					} else {
						o.length && ($.set(this, t, {value: E.event.trigger(E.extend(o[0], E.Event.prototype), o.slice(1), this)}), e.stopImmediatePropagation());
					}
				},
		...
		E.event = {
			global: {}, add: function (e, t, n, r, i) {
				...
				if (g) {
					for (
						n.handler && (n = (o = n).handler, i = o.selector), i && E.find.matchesSelector(se, i), n.guid || (n.guid = E.guid++), (c = g.events) || (c = g.events = {}), (a = g.handle) || (a = g.handle = function (t) {
							return void 0 !== E && E.event.triggered !== t.type ? E.event.dispatch.apply(e, arguments) : void 0;
						}), u = (t = (t || "").match(F) || [""]).length; u--;) {
						f = m = (s = ke.exec(t[u]) || [])[1], h = (s[2] || "").split(".").sort(), f && (d = E.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, d = E.event.special[f] || {}, l = E.extend({
							type: f,
							origType: m,
							data: r,
							handler: n,
				...
				if (g && (c = g.events)) {
					for (u = (t = (t || "").match(F) || [""]).length; u--;) {
						if (f = m = (s = ke.exec(t[u]) || [])[1], h = (s[2] || "").split(".").sort(), f) {
							for (d = E.event.special[f] || {}, p = c[f = (r ? d.delegateType : d.bindType) || f] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = p.length; o--;) {
								l = p[o], !i && m !== l.origType || n && n.guid !== l.guid || s && !s.test(l.namespace) || r && r !== l.selector && ("**" !== r || !l.selector) || (p.splice(o, 1), l.selector && p.delegateCount--, d.remove && d.remove.call(e, l));
							}
							a && !p.length && (d.teardown && !1 !== d.teardown.call(e, h, g.handle) || E.removeEvent(e, f, g.handle), delete c[f]);
						} else {
							for (f in c) {
								E.event.remove(e, f + t[u], n, r, !0);
							}
						}
					}
				...
				var t, n, r, i, o, a, s = E.event.fix(e), c = new Array(arguments.length),
					u = ($.get(this, "events") || {})[s.type] || [], l = E.event.special[s.type] || {};
				for (c[0] = s, t = 1; t < arguments.length; t++) {
					c[t] = arguments[t];
				}
				if (s.delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, s)) {
					for (a = E.event.handlers.call(this, s, u), t = 0; (i = a[t++]) && !s.isPropagationStopped();) {
						for (s.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !s.isImmediatePropagationStopped();) {
							s.rnamespace && !1 !== o.namespace && !s.rnamespace.test(o.namespace) || (s.handleObj = o, s.data = o.data, void 0 !== (r = ((E.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, c)) && !1 === (s.result = r) && (s.preventDefault(), s.stopPropagation()));
						}
					}
				...
				if (c && u.nodeType && !("click" === e.type && 1 <= e.button)) {
					for (; u !== this; u = u.parentNode || this) {
						if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
							for (o = [], a = {}, n = 0; n < c; n++) {
								void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? -1 < E(i, this).index(u) : E.find(i, this, null, [u]).length), a[i] && o.push(r);
							}
		...
		var Be = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
			Pe = /<script|<style|<link/i, Ie = /checked\s*(?:[^=]|=\s*.checked.)/i,
			De = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
		...
		function He(e, t, n, r) {
			t = u.apply([], t);
			var i, o, a, s, c, l, d = 0, p = e.length, f = p - 1, h = t[0], m = v(h);
			if (m || 1 < p && "string" == typeof h && !y.checkClone && Ie.test(h)) {
			...
			if (p && (o = (i = Ee(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
				for (s = (a = E.map(xe(i, "script"), je)).length; d < p; d++) {
					c = i, d !== f && (c = E.clone(c, !0, !0), s && E.merge(a, xe(c, "script"))), n.call(e[d], c, d);
				}
				if (s) {
					for (l = a[a.length - 1].ownerDocument, E.map(a, Fe), d = 0; d < s; d++) {
						c = a[d], ye.test(c.type || "") && !$.access(c, "globalEval") && E.contains(l, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? E._evalUrl && !c.noModule && E._evalUrl(c.src, {nonce: c.nonce || c.getAttribute("nonce")}) : b(c.textContent.replace(De, ""), c, l));
					}
				}
			}
			return e;
		...
		function qe(e, t, n) {
			for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++) {
				n || 1 !== r.nodeType || E.cleanData(xe(r)), r.parentNode && (n && ce(r) && Ae(xe(r, "script")), r.parentNode.removeChild(r));
			}
			return e;
		}
		...
		E.extend({
			htmlPrefilter: function (e) {
				...
				var r, i, o, a, s, c, u, l = e.cloneNode(!0), d = ce(e);
				if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e))) {
					for (a = xe(l), r = 0, i = (o = xe(e)).length; r < i; r++) {
						s = o[r], "input" === (u = (c = a[r]).nodeName.toLowerCase()) && me.test(s.type) ? c.checked = s.checked : "input" !== u && "textarea" !== u || (c.defaultValue = s.defaultValue);
					}
				}
				if (t) {
					if (n) {
						for (o = o || xe(e), a = a || xe(l), r = 0, i = o.length; r < i; r++) {
							_e(o[r], a[r]);
						}
					} else {
						_e(e, l);
			...
			detach: function (e) {
				...
				for (var e, t = 0; null != (e = this[t]); t++) {
					1 === e.nodeType && (E.cleanData(xe(e, !1)), e.textContent = "");
				}
				return this;
			}, clone: function (e, t) {
				...
				return V(this, function (e) {
					...
					if ("string" == typeof e && !Pe.test(e) && !ve[(ge.exec(e) || ["", ""])[1].toLowerCase()]) {
						...
						try {
							for (; n < r; n++) {
								1 === (t = this[n] || {}).nodeType && (E.cleanData(xe(t, !1)), t.innerHTML = e);
							}
							t = 0;
						} catch (e) {
						}
		...
		var Ge = new RegExp("^(" + ie + ")(?!px)[a-z%]+$", "i"), Ke = function (e) {
		...
		function rt(e, t, n, r, i, o) {
			...
			for (; a < 4; a += 2) {
				"margin" === n && (c += E.css(e, n + ae[a], !0, i)), r ? ("content" === n && (c -= E.css(e, "padding" + ae[a], !0, i)), "margin" !== n && (c -= E.css(e, "border" + ae[a] + "Width", !0, i))) : (c += E.css(e, "padding" + ae[a], !0, i), "padding" !== n ? c += E.css(e, "border" + ae[a] + "Width", !0, i) : s += E.css(e, "border" + ae[a] + "Width", !0, i));
			}
			return !r && 0 <= o && (c += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - o - c - s - .5)) || 0), c;
		}

		function it(e, t, n) {
			var r = Ke(e), i = (!y.boxSizingReliable() || n) && "border-box" === E.css(e, "boxSizing", !1, r), o = i,
		...
		E.extend({
			...
			style: function (e, t, n, r) {
				if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
					var i, o, a, s = Y(t), c = $e.test(t), u = e.style;
					if (c || (t = Je(s)), a = E.cssHooks[t] || E.cssHooks[s], void 0 === n) {
			...
			E.cssHooks[t] = {
				get: function (e, n, r) {
					if (n) {
						return !Ze.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? it(e, t, r) : de(e, et, function () {
							return it(e, t, r);
						});
					}
				}, set: function (e, n, r) {
					var i, o = Ke(e), a = !y.scrollboxSize() && "absolute" === o.position,
						s = (a || r) && "border-box" === E.css(e, "boxSizing", !1, o), c = r ? rt(e, t, r, s, o) : 0;
			...
			if (t) {
				return (parseFloat(Ve(e, "marginLeft")) || e.getBoundingClientRect().left - de(e, {marginLeft: 0}, function () {
		...
		var at, st, ct, ut, lt = /^(?:toggle|show|hide)$/, dt = /queueHooks$/;
		...
		function gt(e, t, n) {
			...
			for (
				...
				if (r = gt.prefilters[o].call(u, e, l, u.opts)) {
					return v(r.stop) && (E._queueHooks(u.elem, u.opts.queue).stop = r.stop.bind(r)), r;
				}
			}
		...
		E.Animation = E.extend(gt, {
			tweeners: {
				...
				var r, i, o, a, s, c, u, l, d = "width" in t || "height" in t, p = this, f = {}, h = e.style,
					m = e.nodeType && le(e), g = $.get(e, "fxshow");
				...
				if ((c = !E.isEmptyObject(t)) || !E.isEmptyObject(f)) {
					for (r in d && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (u = g && g.display) && (u = $.get(e, "display")), "none" === (l = E.css(e, "display")) && (u ? l = u : (he([e], !0), u = e.style.display || u, l = E.css(e, "display"), he([e]))), ("inline" === l || "inline-block" === l && null != u) && "none" === E.css(e, "float") && (c || (p.done(function () {
						...
						c || (g ? "hidden" in g && (m = g.hidden) : g = $.access(e, "fxshow", {display: u}), o && (g.hidden = !m), m && he([e], !0), p.done(function () {
							for (r in m || he([e]), $.remove(e, "fxshow"), f) {
								E.style(e, r, f[r]);
							}
			...
			fadeTo: function (e, t, n, r) {
				...
				return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function () {
					var t = !0, i = null != e && e + "queueHooks", o = E.timers, a = $.get(this);
					if (i) {
						a[i] && a[i].stop && r(a[i]);
					} else {
						for (i in a) {
				...
				return !1 !== e && (e = e || "fx"), this.each(function () {
					var t, n = $.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = E.timers,
						a = r ? r.length : 0;
		...
		E.fn.extend({
			...
			attr: function (e, t, n) {
				...
				if (3 !== o && 8 !== o && 2 !== o) {
					return void 0 === e.getAttribute ? E.prop(e, t, n) : (1 === o && E.isXMLDoc(e) || (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? yt : void 0)), void 0 !== n ? null === n ? void E.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : null == (r = E.find.attr(e, t)) ? void 0 : r);
				}
			}, attrHooks: {
				type: {
					set: function (e, t) {
		...
		var xt = /^(?:input|select|textarea|button)$/i, At = /^(?:a|area)$/i;
		...
		E.fn.extend({
			...
			addClass: function (e) {
				...
				return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : v(e) ? this.each(function (n) {
					...
					var t, i, o, a;
					if (r) {
						for (i = 0, o = E(this), a = Tt(e); t = a[i++];) {
							o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
						}
					} else {
						void 0 !== e && "boolean" !== n || ((t = wt(this)) && $.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : $.get(this, "__className__") || ""));
					}
				});
			}, hasClass: function (e) {
				var t, n, r = 0;
		...
		E.extend(E.event, {
			trigger: function (e, t, r, i) {
				var o, s, c, u, l, d, p, f, m = [r || a], g = h.call(e, "type") ? e.type : e,
				...
				if (s = f = c = r = r || a, 3 !== r.nodeType && 8 !== r.nodeType && !St.test(g + E.event.triggered) && (-1 < g.indexOf(".") && (g = (y = g.split(".")).shift(), y.sort()), l = g.indexOf(":") < 0 && "on" + g, (e = e[E.expando] ? e : new E.Event(g, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = y.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + y.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : E.makeArray(t, [e]), p = E.event.special[g] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, t))) {
					if (!i && !p.noBubble && !x(r)) {
						for (u = p.delegateType || g, St.test(u + g) || (s = s.parentNode); s; s = s.parentNode) {
							m.push(s), c = s;
						}
						c === (r.ownerDocument || a) && m.push(c.defaultView || c.parentWindow || n);
					}
					for (o = 0; (s = m[o++]) && !e.isPropagationStopped();) {
						f = s, e.type = 1 < o ? u : p.bindType || g, (d = ($.get(s, "events") || {})[e.type] && $.get(s, "handle")) && d.apply(s, t), (d = l && s[l]) && d.apply && J(s) && (e.result = d.apply(s, t), !1 === e.result && e.preventDefault());
					}
			...
			E.event.special[t] = {
				setup: function () {
					var r = this.ownerDocument || this, i = $.access(r, t);
					i || r.addEventListener(e, n, !0), $.access(r, t, (i || 0) + 1);
				}, teardown: function () {
					var r = this.ownerDocument || this, i = $.access(r, t) - 1;
					i ? $.access(r, t, i) : (r.removeEventListener(e, n, !0), $.remove(r, t));
				},
			};
		});
		var kt = n.location, Rt = Date.now(), Lt = /\?/;
		...
		var It = /%20/g, Dt = /#.*$/, Ut = /([?&])_=[^&]*/, jt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ft = /^(?:GET|HEAD)$/,
			_t = /^\/\//, Ht = {}, qt = {}, Gt = "*/".concat("*"), Kt = a.createElement("a");
		...
		Kt.href = kt.href, E.extend({
			...
			ajax: function (e, t) {
				...
				var r, i, o, s, c, u, l, d, p, f, h = E.ajaxSetup({}, t), m = h.context || h,
					g = h.context && (m.nodeType || m.jquery) ? E(m) : E.event, y = E.Deferred(),
					v = E.Callbacks("once memory"), x = h.statusCode || {}, A = {}, b = {}, w = "canceled", T = {
				...
				if (h.data && h.processData && "string" != typeof h.data && (h.data = E.param(h.data, h.traditional)), Vt(Ht, h, t, T), l) {
					return T;
				}
				for (p in (d = E.event && h.global) && 0 == E.active++ && E.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ft.test(h.type), i = h.url.replace(Dt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(It, "+")) : (f = h.url.slice(i.length), h.data && (h.processData || "string" == typeof h.data) && (i += (Lt.test(i) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (i = i.replace(Ut, "$1"), f = (Lt.test(i) ? "&" : "?") + "_=" + Rt++ + f), h.url = i + f), h.ifModified && (E.lastModified[i] && T.setRequestHeader("If-Modified-Since", E.lastModified[i]), E.etag[i] && T.setRequestHeader("If-None-Match", E.etag[i])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Gt + "; q=0.01" : "") : h.accepts["*"]), h.headers) {
				...
				if (w = "abort", v.add(h.complete), T.done(h.success), T.fail(h.error), r = Vt(qt, h, t, T)) {
					if (T.readyState = 1, d && g.trigger("ajaxSend", [T, h]), l) {
						return T;
					}
		...
		var zt = {0: 200, 1223: 204}, Qt = E.ajaxSettings.xhr();
		...
		E.ajaxSetup({
			...
			if (s || "jsonp" === e.dataTypes[0]) {
				return i = e.jsonpCallback = v(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Zt, "$1" + i) : !1 !== e.jsonp && (e.url += (Lt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
			...
			setOffset: function (e, t, n) {
				var r, i, o, a, s, c, u = E.css(e, "position"), l = E(e), d = {};
			...
			E.fn[e] = function (r) {
				return V(this, function (e, r, i) {
					var o;
					if (x(e) ? o = e : 9 === e.nodeType && (o = e.defaultView), void 0 === i) {
						return o ? o[t] : e[r];
					}
			...
			E.cssHooks[t] = We(y.pixelPosition, function (e, n) {
				if (n) {
					return n = Ve(e, t), Ge.test(n) ? E(e).position()[t] + "px" : n;
				}
			});
			...
			if ("string" == typeof t && (n = e[t], t = e, e = n), v(e)) {
				return r = c.call(arguments, 2), (i = function () {
			...
			1: [function (e, t, n) {
				...
				(function (t) {
					...
					function o() {
						...
						}, this.m = 0, this.n = !1, this.o = Error.stackTraceLimit, this.p = G.console || {}, this.q = {}, this.r = [], this.s = r(), this.t = [], this.u = [], this.v = null, this.w = G.location, this.x = this.w && this.w.href, this.y(), this.p) {
							this.q[e] = this.p[e];
						}
					}

					var a = e(6), s = e(7), c = e(8), u = e(1), l = e(5), d = l.isErrorEvent, p = l.isDOMError,
						f = l.isDOMException, h = l.isError, m = l.isObject, g = l.isPlainObject, y = l.isUndefined,
						v = l.isFunction, x = l.isString, A = l.isArray, b = l.isEmptyObject, w = l.each,
						T = l.objectMerge, E = l.truncate, S = l.objectFrozen, C = l.hasKey, k = l.joinRegExp,
						R = l.urlencode, L = l.uuid4, O = l.htmlTreeAsString, N = l.isSameException,
						M = l.isSameStacktrace, B = l.parseUrl, P = l.fill, I = l.supportsFetch,
						D = l.supportsReferrerPolicy, U = l.serializeKeysForMessage, j = l.serializeException,
						F = l.sanitize, _ = e(2).wrapMethod, H = "source protocol user pass host port path".split(" "),
						q = /^(?:(\w+):)?\/\/(?:(\w+)(:\w+)?@)?([\w\.-]+)(?::(\d+))?(\/.*)/,
						G = "undefined" != typeof window ? window : void 0 !== t ? t : "undefined" != typeof self ? self : {},
						K = G.document, X = G.navigator;
					o.prototype = {
						VERSION: "3.26.4", debug: !1, TraceKit: a, config: function (e, t) {
							var n = this;
							if (n.g) {
								return this.z("error", "Error: Raven has already been configured"), n;
							}
							if (!e) {
								return n;
							}
							...
							if (t = T({trimHeadFrames: 0}, t || {}), d(e) && e.error) {
								e = e.error;
							} else {
								if (p(e) || f(e)) {
								...
								if (h(e)) {
									...
									if (!g(e)) {
										return this.captureMessage(e, T(t, {
											stacktrace: !0,
											trimHeadFrames: t.trimHeadFrames + 1,
										}));
									}
							...
							var n = Object.keys(t).sort(), r = T(e, {
							...
							if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(e)) {
								...
								n.name = null;
								var i = a.computeStackTrace(n), o = A(i.stack) && i.stack[1];
								...
								if ((!this.k.ignoreUrls.test || !this.k.ignoreUrls.test(s)) && (!this.k.whitelistUrls.test || this.k.whitelistUrls.test(s))) {
									if (this.k.stacktrace || t.stacktrace || "" === r.message) {
										r.fingerprint = null == r.fingerprint ? e : r.fingerprint, (t = T({trimHeadFrames: 0}, t)).trimHeadFrames += 1;
										var c = this.X(i, t);
							...
							if (K) {
								...
								var o = this.J(this.G(e.dsn)), a = K.createElement("script");
							...
							var n, r;
							if (this.b) {
								for (r in t = t || {}, e = "raven" + e.substr(0, 1).toUpperCase() + e.substr(1), K.createEvent ? (n = K.createEvent("HTMLEvents")).initEvent(e, !0, !0) : (n = K.createEventObject()).eventType = e, t) {
									C(t, r) && (n[r] = t[r]);
								}
								if (K.createEvent) {
									K.dispatchEvent(n);
							...
							var n = B(this.w.href), r = B(t), i = B(e);
							...
							n.xhr && I() && P(G, "fetch", function (e) {
								return function () {
									...
									var i, o = n[0], a = "GET";
									if ("string" == typeof o ? i = o : "Request" in G && o instanceof G.Request ? (i = o.url, o.method && (a = o.method)) : i = "" + o, -1 !== i.indexOf(t.h)) {
							...
							for (var t, n, r, i = ["to", "from", "url"], o = 0; o < e.values.length; ++o) {
								if ((n = e.values[o]).hasOwnProperty("data") && m(n.data) && !S(n.data)) {
									...
									for (var a = 0; a < i.length; ++a) {
										t = i[a], r.hasOwnProperty(t) && r[t] && (r[t] = E(r[t], this.k.maxUrlLength));
									}
									e.values[o].data = r;
								}
							}
							...
							if (this.c || this.b) {
								var e = {};
								return this.c && X.userAgent && (e.headers = {"User-Agent": X.userAgent}), G.location && G.location.href && (e.url = G.location.href), this.b && K.referrer && (e.headers || (e.headers = {}), e.headers.Referer = K.referrer), e;
							}
						}, y: function () {
				...
				(function (t) {
					...
					function d(e) {
						for (var t, n = [], r = 0, i = e.length; r < i; r++) {
							o(t = e[r]) ? n.push(t.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1")) : t && t.source && n.push(t.source);
						}
					...
					function p(e) {
						...
						for (a = 0; a < c.length; a++) {
							r = c[a], (i = e.getAttribute(r)) && s.push("[" + r + "=\"" + i + "\"]");
						}
						return s.join("");
					}
					...
					n.exports = {
						...
						}, hasKey: l, joinRegExp: d, urlencode: function (e) {
							var t = [];
				...
				(function (t) {
					...
					o.report = function () {
						...
						function t(t, a, s, l, p) {
							var f = i.isErrorEvent(p) ? p.error : p, h = i.isErrorEvent(t) ? t.message : t;
							if (g) {
								o.computeStackTrace.augmentStackTraceWithInitialElement(g, a, s, h), n();
							} else if (f && i.isError(f)) {
								e(o.computeStackTrace(f), !0);
							} else {
								var m = {url: a, line: s, column: l}, y = void 0;
								if ("[object String]" === {}.toString.call(h)) {
									var v = h.match(u);
									v && (y = v[1], h = v[2]);
								}
								m.func = c, e({name: y, message: h, url: r(), stack: [m]}, !0);
							}
						...
						function l(e, t) {
							...
							if (g = i, m = e, h = r, setTimeout(function () {
								m === e && n();
							}, i.incomplete ? 2e3 : 0), !1 !== t) {
								throw e;
							}
						}

						var d, p, f = [], h = null, m = null, g = null;
							...
							for (var s, u, l = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, d = [], p = {}, f = !1, h = n.caller; h && !f; h = h.caller) {
								if (h !== i && h !== o.report) {
									if (u = {
										...
										line: null,
										column: null,
									}, h.name ? u.func = h.name : (s = l.exec(h.toString())) && (u.func = s[1]), void 0 === u.func) {
										try {
				...
				function m(e, t) {
					return function (e, t) {
						var n, r, i = d(e), o = [], a = [];
						for (o[15] = a[15] = void 0, i.length > 16 && (i = u(i, 8 * e.length)), n = 0; n < 16; n += 1) {
	...
	var n = "lqkr1tfixq1wa9kmj9po", r = !1;
	...
	!function () {
		...
		if (!(t && t.length > 0)) {
			var n = r(3), i = r(18), o = (r(19), r(0)), a = r(24), s = r(5), c = r(26), u = r(2);
			if (r(27), !0 !== s.disable) {
				var l, d = "cyxy-trs-source", p = "cyxy-trs-source-ted", f = "cyxy-trs-target", h = "cyxy-target-count",
					m = "cyxy-no-trs", g = (s.token, "小译火力全开！LingoCloud, FIRE!"), y = "+30 彩云朵！现有：",
					v = "限免次数已不足，成为小译注册用户，畅享更多阅读次数！现在注册还送彩云朵哟~", x = "诶呦喂~彩云朵不足！修订译文或点击赞、分享赚取彩云朵，或购买VIP畅享无限阅读次数",
					A = "抱歉，网页认证有误，请刷新重试", b = "抱歉，网络请求有误，请刷新重试", w = "提交有误", T = "感谢点赞，+5 彩云朵！", E = "已经赞过啦",
					S = "彩云小译", C = "刚刚", k = "提交", R = "现在", L = navigator.userAgent, O = "", N = "", M = 0, B = {},
					P = "", I = "0", D = location.origin + location.pathname, U = 2300, j = "b";
					...
					try {
						...
						!function () {
							...
							function n() {
								...
								var n = l.data("targetList"), r = l.data("index");
							...
							t.className = "cyxy-target-popup " + d, t.innerHTML = "<div style=\"margin: auto\"><img id=\"cyxy-popup-left-slide\" src=\"https://caiyunapp.com/imgs/webtrs/left-slide.png\"> <div id=\"cyxy-popup-userinfo\"><img id=\"cyxy-popup-avatar\" src=\"https://caiyunapp.com/imgs/xiaoyilogo.jpg\" /> <div id=\"cyxy-popup-name-time\"> <span id=\"cyxy-popup-name\">彩云小译</span> <span id=\"cyxy-popup-time\">刚刚</span></div></div><div id=\"cyxy-popup-favour\"><img id=\"cyxy-popup-favour-img\" src=\"https://caiyunapp.com/images/favour.png\"><span id=\"cyxy-popup-favour-num\">0</span></div><img id=\"cyxy-popup-right-slide\" src=\"https://caiyunapp.com/imgs/webtrs/right-slide.png\"></div>", document.body.appendChild(t), u(".cyxy-target-popup").hide(), u("#cyxy-popup-left-slide").hide(), u("#cyxy-popup-right-slide").hide(), u(".cyxy-target-popup").click(function () {
								...
								W();
								var e = l.data("targetList"), t = l.data("index");
								if (!isNaN(t)) {
								...
								if (u("#cyxy-popup-favour").hasClass("commit")) {
									P && (l.data("before") !== l.text() ? l.data("user_s_id") ? function (t, n, r, i) {
										if (!H) {
											ae();
										...
										if (u("#cyxy-popup-favour").removeClass("commit"), e && 0 == e.rc) {
											...
											var t = l.data("targetList"), n = l.data("user_index"), r = 0;
											l.data("targetInfo") && (r = l.data("targetInfo").rate.LIKE), t && t.length > 0 && n >= 0 && (t[n].content = l.text(), t[n].rate.lIKE = r, l.data("targetList", t)), u("#cyxy-popup-favour-num").text(r || 0), l.data("targetInfo", {
												...
												content: l.text(),
												updated_at: Date.now(),
												user: {id: P, avatar_url: B.avatar_url, username: B.username},
											...
											o.open({content: w, skin: "msg", time: 3});
										}
										...
										if (u("#cyxy-popup-favour").removeClass("commit"), e && 0 == e.rc) {
											...
											var t = {
												...
												updated_at: Date.now(),
												user: {id: P, avatar_url: B.avatar_url, username: B.username},
												rate: {LIKE: u("cyxy-popup-favour-num").text(), UNLIKE: 0},
											};
											l.data("targetInfo", t);
											...
											}) : o.open({content: "" + y + e.point.total_point, skin: "msg", time: 3});
										} else {
											o.open({content: w, skin: "msg", time: 3});
										}
										var r, i, a, c;
								...
								var e = l.data("comment"), t = l.data("sentence_id");
							...
							e ? (t = P = e._id, n = function (e) {
								...
								url: r,
								headers: {"X-Authorization": "token " + s.token},
								data: {user_id: P, page_id: M, url: document.URL},
							}, function (e) {
								if ("ok" == e.status) {
							...
							chrome.storage.sync.get({targetBkgColor: ""}, function (e) {
								if (e.targetBkgColor) {
				...
				var _ = null, H = !1, q = new Date;
				window.cyPageMark = function () {
					var e = c.wordStatistics(document.body), t = Math.round(((new Date).getTime() - q.getTime()) / 1e3),
		...
		function V() {
			...
			chrome.runtime.sendMessage({
				...
				var n, r, i, y = JSON.parse(t.data), w = y.auth_type;
				0 == y.rc ? w >= 0 && (o.open({
					className: m,
					content: g,
					skin: "msg",
					...
					if (!(t && t.length > 5)) {
						var n = [], r = [], i = [], o = [], g = [], y = (Date.now(), null), v = [];
						setInterval(function () {
						...
						}, 500), u("body").on("click", "." + f + "[contenteditable]", function () {
								...
								if (0 == e.rc) {
									...
									if (n && n.length > 0) {
										...
										for (var r = 0, i = n.length; r < i; r++) {
											n[r] && (n[r].user && P == n[r].user.id && (l.data("user_s_id", n[r].id), l.data("user_index", r)), n[r].invalid && (n.splice(r, 1), r--));
										}
							...
							for (var t = this, n = t.offsetTop + t.offsetHeight + 5, r = t.offsetLeft; t.offsetParent;) {
								n += (t = t.offsetParent).offsetTop, r += t.offsetLeft;
							}
					...
					function b() {
						for (var e = [], t = [], a = [], s = [], c = [], u = [], l = 0, d = i.length; l < d; l++) {
							ie(i[l]) && (e = e.concat(i.splice(l, 1)), l--);
						}
						for (l = 0, d = n.length; l < d; l++) {
							ie(n[l]) && (t = t.concat(n.splice(l, 1)), l--);
						}
						r.length > 0 && w(a = a.concat(r.splice(0, r.length)), "pre");
						for (l = 0, d = o.length; l < d; l++) {
							ie(o[l]) && (s = s.concat(o.splice(l, 1)), l--);
						}
						for (l = 0, d = g.length; l < d; l++) {
							ie(g[l]) && (c = c.concat(g.splice(l, 1)), l--);
						}
						for (l = 0, d = v.length; l < d; l++) {
							oe(v[l]) && (u = u.concat(v.splice(l, 1)), l--);
						}
					...
					function w(e, t) {
						for (var n = [], r = [], i = [], o = [], a = [], s = [], u = [], l = [], d = [], p = 0, f = e.length; p < f; p++) {
							...
							if (m = m.trim()) {
								var g = c.detectLang(m), y = m.length;
								if ("jp" == g) {
									y > 30 ? u.push(h) : y > 8 ? l.push(h) : d.push(h);
								} else if ("zh" == g) {
									y > 30 ? a.push(h) : y > 8 ? o.push(h) : s.push(h);
								} else {
					...
					function E(t, n, r) {
						...
						if (!(i.length <= 0)) {
							var l = "en2zh", d = s.TRS_URL + "/v1/page/translator";
									...
									for (var c = 0, l = t.length; c < l; c++) {
										...
										if (s[c] && s[c].target) {
											...
											if (i[c].trim().toLowerCase() !== m.toLowerCase()) {
												...
												var v = s[c].count || 0, x = null;
												if ("p" == n) {
													if ((x = d.cloneNode(!0)).innerText = m, P && m.length > 4 && (x.contentEditable = !0), re(x, f), x.sentence_id = y, x.source_text = g, v > 1) {
														(A = document.createElement("span")).className = h, A.innerText = "(" + v + ")", x.appendChild(A);
													}
													d.parentNode.insertBefore(x, d.nextSibling);
												} else if ("pre" == n) {
													if ("" != (x = u(d).children("." + f)[0]).innerText) {
														continue;
													}
													m = ne(m), P && m.length > 4 && (x.contentEditable = !0), x.sentence_id = y, x.source_text = te(d.innerText), x.innerText = " " + m;
												} else if ("h" == n) {
													if (m = ne(m), (x = d.cloneNode(!0)).innerText = m, P && m.length > 4 && (x.contentEditable = !0), x.sentence_id = y, x.source_text = te(d.innerText), re(x, f), v > 1) {
														(A = document.createElement("span")).className = h, A.innerText = "(" + v + ")", x.appendChild(A);
													}
													d.parentNode.insertBefore(x, d.nextSibling);
												} else if ("sub" == n) {
													m = ne(m), sourceClone = d.firstElementChild.cloneNode(!0), targetClone = d.firstElementChild.cloneNode(!0), targetClone.firstChild.innerText = m, re(targetClone, f), d.appendChild(targetClone);
												} else {
													if (m = ne(m), i[c].trim().toLowerCase() === m.toLowerCase()) {
														continue;
													}
													var A;
													if (re(x = document.createElement("font"), f), P && m.length > 4 && "A" != d.parentNode.nodeName && (x.contentEditable = !0), x.sentence_id = y, x.source_text = te(d.nodeValue), d.source = d.nodeValue, v > 1) {
														(A = document.createElement("span")).className = h, A.innerText = "(" + v + ")", sp.appendChild(A);
													}
					...
					!function (t) {
						...
						chrome.runtime.sendMessage({
							...
							var n = JSON.parse(t.data);
							if (0 == n.rc) {
								var r = n.user_list, i = r.length, o = "", a = "", c = "";
								...
								"和" == a && u(".cyxy-footer").show(), "share" == F && (u(".cyxy-footer").show(), u(".cyxy-footer").click(function () {
									...
									u(".cyxy-footer").css({opacity: .88}), u(".cyxy-footer").hide();
								}, l);
							}
						});
					}();
					...
					e = s.TRS_URL + "/v1/coupon/generate", chrome.runtime.sendMessage({
						...
						})), n = {coupon_code: t.coupon.coupon_code, device_id: t.coupon.device_id}), function (e) {
							var t = "", n = "", r = "";
					...
					content: x, btn: ["成为VIP", "取消"], yes: function (e) {
		...
		function z(t, n, r, i, a) {
			if (!H) {
				ae();
				var c = s.TRS_URL + "/v1/page/" + M + "/sentence", u = P;
				a && (u = a), H = !0, chrome.runtime.sendMessage({
					method: "POST",
					contentScriptQuery: "fetchUrl",
					url: c,
					headers: {"X-Authorization": "token " + s.token},
					data: {user_id: u, page_id: M, source: t, target: n, trans_type: "en2zh", action: r || ""},
				}, function (t) {
					if ("ok" != t.status) {
						throw H = !1, o.open({
							content: w,
		...
		function Q(t, n, r, i) {
			if (!H) {
				...
				chrome.runtime.sendMessage({
					...
					url: a,
					headers: {"X-Authorization": "token " + s.token},
					data: {user_id: P, sentence_id: t, trans_type: "en2zh", action: n},
				}, function (t) {
					if ("ok" != t.status) {
						throw H = !1, o.open({
							content: w,
					...
					H = !1;
					var n = JSON.parse(t.data);
					0 == n.rc ? (o.open({content: T, skin: "msg", time: 2}), r()) : -1 == n.rc ? o.open({
						content: E,
						skin: "msg",
						time: 2,
					}) : o.open({content: w, skin: "msg", time: 3});
	...
	!function (t, n, r) {
		...
		return e.prototype = {
			extend: function (e, t) {
				...
				if (null == n) {
					return e.addPreprocessedComponent({key: "audio_fp", value: null}), t(e);
				}
				...
				this.each([["threshold", -50], ["knee", 40], ["ratio", 12], ["reduction", -20], ["attack", 0], ["release", .25]], function (e) {
					...
					return i.disconnect(), o.disconnect(), e.addPreprocessedComponent({key: "audio_fp", value: r}), t(e);
				...
				return setTimeout(function () {
					...
					var o = document.getElementsByTagName("body")[0], a = document.createElement("div"),
						s = document.createElement("div"), c = {}, u = {}, l = function () {
							...
							for (var t = !1, n = 0; n < r.length; n++) {
								if (t = e[n].offsetWidth !== c[r[n]] || e[n].offsetHeight !== u[r[n]]) {
									return t;
								}
							}
							return t;
					...
					for (var f = 0, h = r.length; f < h; f++) {
						c[r[f]] = p[f].offsetWidth, u[r[f]] = p[f].offsetHeight;
					}
					var m = function () {
					...
					o.appendChild(s);
					for (var g = [], y = 0, v = i.length; y < v; y++) {
						d(m[i[y]]) && g.push(i[y]);
					}
					o.removeChild(s), o.removeChild(a), e.addPreprocessedComponent({key: "js_fonts", value: g}), t(e);
				}, 1);
	...
	n(22)(r, {hmr: !0, transform: void 0, insertInto: void 0}), r.locals && (e.exports = r.locals);
}, function (e, t, n) {
	...
	function h(e, t) {
		...
		var r = l[l.length - 1];
		if ("top" === e.insertAt) {
			r ? r.nextSibling ? n.insertBefore(t, r.nextSibling) : n.appendChild(t) : n.insertBefore(t, n.firstChild), l.push(t);
	...
	function a() {
		...
		return t.onerror = function (e) {
			throw o.open({content: i.NETWORK_ERROR_MSG, skin: "msg", time: 3}), new Error("XHR.onerror", e);
		}, t;
	}
	...
	t.exports.testCookie = function (e) {
		chrome.runtime.sendMessage({
			...
			if ("ok" == t.status) {
				...
				o.open({content: i.PAGE_COOKIE_ERROR_MSG, skin: "msg", time: 6});
			}
		});
	...
	t.levenshteinDistance = function (e, t) {
		...
		for (n = 1; n <= t.length; n++) {
			for (r = 1; r <= e.length; r++) {
				t.charAt(n - 1) == e.charAt(r - 1) ? i[n][r] = i[n - 1][r - 1] : i[n][r] = Math.min(i[n - 1][r - 1] + 1, Math.min(i[n][r - 1] + 1, i[n - 1][r] + 1));
			}
		}
		return i[t.length][e.length]
	}, t.getDateDiff = function (e) {
		"string" == typeof e && (e = new Date(e).getTime());
		var t = (new Date).getTime() - 1e3 * e, n = "刚刚";
		if (t < 0) {
			return n;
		}
		var r = t / 2592e6, i = t / 6048e5, o = t / 864e5, a = t / 36e5, s = t / 6e4;
		...
		var t = "en", n = (e.match(/[\u4e00-\u9fa5]/g) || []).length / e.length;
		...
		for (var t = e.innerText.replace(/\r\n/g, "\n"), n = t.replace(/\n/g, ""), r = t.match(/[\u4e00-\u9fa5]/g) || [], i = t.match(/\b\w+\b/g) || [], o = t.match(/\b\d+\b/g) || [], a = (n.match(/[|\~|\`|\!|\@|\#|\jq|\%|\^|\&|\*|\(|\)|\-|\_|\+|\=|\||\\|\[|\]|\{|\}|\;|\:|\"|\'|\,|\<|\.|\>|\/|\?]/g), 0); a < n.length; a++) {
			n.charAt(a).match(/[^\x00-\xff]/);
		}
	...
	function p() {
		for (let e = 0, t = l.length; e < t; e++) {
			r(`.cyxy-${l[t - e - 1]}`).stop().fadeIn(i * e);
		}
		r(".cyxy-ctrl-wrapper").css({height: "310px"}), chrome.storage.sync.set({btnGroupShow: !0})
	}

	function f() {
		for (let e = 0, t = l.length; e < t; e++) {
			r(`.cyxy-${l[e]}`).stop().fadeOut(i * e);
		}
		r(".cyxy-ctrl-wrapper").css({height: "50px"}), chrome.storage.sync.set({btnGroupShow: !1})
	}

	r("body").append(d), r(".cyxy-options-btn").click(function () {
		chrome.runtime.sendMessage({tag: "options"})
	}), r(".cyxy-video-trans").click(function () {
		chrome.runtime.sendMessage({type: "checkPms"}), document.getElementById("substr") ? chrome.runtime.sendMessage({type: "closeSubByVideoBtn"}) : chrome.runtime.sendMessage({type: "showSubByVideoBtn"})
	}), (d = document.getElementsByClassName("cyxy-ctrl-btn")[0]).addEventListener("click", function (e, t) {
		let n = null;
		return function () {
			n || (function () {
				chrome.runtime.sendMessage({type: "checkPms"}), o ? p() : f(), o = !o, clearTimeout(u)
	...
	}), chrome.storage.sync.get({isFirst: !0, btnGroupShow: !1}, function (e) {
		1 == e.isFirst ? (p(), o = !1, u = setTimeout(() => {
			f(), o = !0
		}, 8e3), chrome.storage.sync.set({isFirst: !1})) : e.btnGroupShow ? (p(), o = !1) : (f(), o = !0)
