!function (e) {
			...
			1: [function (e, t, n) {
				...
				(function (t) {
					...
					function o() {
						...
						}, this.m = 0, this.n = !1, this.o = Error.stackTraceLimit, this.p = $.console || {}, this.q = {}, this.r = [], this.s = r(), this.t = [], this.u = [], this.v = null, this.w = $.location, this.x = this.w && this.w.href, this.y(), this.p) {
							this.q[e] = this.p[e];
						}
					}
					...
					var a = e(6), s = e(7), c = e(8), u = e(1), l = e(5), f = l.isErrorEvent, h = l.isDOMError,
						...
						y = l.isFunction, b = l.isString, w = l.isArray, E = l.isEmptyObject, S = l.each,
						k = l.objectMerge, x = l.truncate, R = l.objectFrozen, T = l.hasKey, O = l.joinRegExp,
					...
					o.prototype = {
						VERSION: "3.26.4", debug: !1, TraceKit: a, config: function (e, t) {
							...
							"[object Object]" === {}.toString.call(o) ? o = k(i, o) : !1 !== o && (o = i), r.autoBreadcrumbs = o;
							var s = {tryCatch: !0}, c = r.instrument;
							return "[object Object]" === {}.toString.call(c) ? c = k(s, c) : !1 !== c && (c = s), r.instrument = c, a.collectWindowErrors = !!r.collectWindowErrors, n;
						}, install: function () {
							var e = this;
							...
							function r() {
								...
								for (n && y(n) && n.apply(this, arguments); o--;) {
							...
							if (t = k({trimHeadFrames: 0}, t || {}), f(e) && e.error) {
								e = e.error;
							} else {
								if (h(e) || p(e)) {
							...
							if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(e)) {
								...
								if ((!this.k.ignoreUrls.test || !this.k.ignoreUrls.test(s)) && (!this.k.whitelistUrls.test || this.k.whitelistUrls.test(s))) {
									if (this.k.stacktrace || t.stacktrace || "" === r.message) {
										r.fingerprint = null == r.fingerprint ? e : r.fingerprint, (t = k({trimHeadFrames: 0}, t)).trimHeadFrames += 1;
										var c = this.X(i, t);
							...
							var n, r;
							if (this.b) {
								for (r in t = t || {}, e = "raven" + e.substr(0, 1).toUpperCase() + e.substr(1), z.createEvent ? (n = z.createEvent("HTMLEvents")).initEvent(e, !0, !0) : (n = z.createEventObject()).eventType = e, t) {
									T(t, r) && (n[r] = t[r]);
								}
								if (z.createEvent) {
									z.dispatchEvent(n);
							...
							n.xhr && P() && C($, "fetch", function (e) {
								return function () {
									...
									var i, o = n[0], a = "GET";
									if ("string" == typeof o ? i = o : "Request" in $ && o instanceof $.Request ? (i = o.url, o.method && (a = o.method)) : i = "" + o, -1 !== i.indexOf(t.h)) {
							...
							var o = $.chrome,
								a = !(o && o.app && o.app.runtime) && $.history && $.history.pushState && $.history.replaceState;
							if (n.location && a) {
								var s = $.onpopstate;
								$.onpopstate = function () {
									var e = t.w.href;
								...
								C($.history, "pushState", c, r), C($.history, "replaceState", c, r);
							}
							...
							var n = this, r = [];
							if (e.stack && e.stack.length && (S(e.stack, function (t, i) {
								var o = n.ga(i, e.url);
								o && r.push(o);
							}), t && t.trimHeadFrames)) {
							...
							if ((!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(t) && !this.k.ignoreErrors.test(s)) && (i && i.length ? (n = i[0].filename || n, i.reverse(), a = {frames: i}) : n && (a = {
								...
								null == u.type && "" === u.value && (u.value = "Unrecoverable error caught"), !c.exception.mechanism && c.mechanism && (c.exception.mechanism = c.mechanism, delete c.mechanism), c.exception.mechanism = k({
									type: "generic",
									handled: !0,
							...
							for (var t, n, r, i = ["to", "from", "url"], o = 0; o < e.values.length; ++o) {
								if ((n = e.values[o]).hasOwnProperty("data") && m(n.data) && !R(n.data)) {
									...
									for (var a = 0; a < i.length; ++a) {
										t = i[a], r.hasOwnProperty(t) && r[t] && (r[t] = x(r[t], this.k.maxUrlLength));
									}
									e.values[o].data = r;
								}
							}
							...
							a && (("withCredentials" in a || "undefined" != typeof XDomainRequest) && ("withCredentials" in a ? a.onreadystatechange = function () {
								...
								t.request = a, e.onError(t);
							})), a.open("POST", t), n && S(n, function (e, t) {
							...
							v(t) ? delete this.j[e] : this.j[e] = k(this.j[e] || {}, t);
						},
				...
				(function (t) {
					...
					var g = e(7),
						v = "undefined" != typeof window ? window : void 0 !== t ? t : "undefined" != typeof self ? self : {};
					n.exports = {
						isObject: function (e) {
							...
							for (var t, n = [], r = 0, i = 0, o = " > ".length; e && r++ < 5 && !("html" === (t = h(e)) || r > 1 && i + n.length * o + t.length >= 80);) {
				...
				(function (t) {
					...
					o.report = function () {
						...
						function t(t, a, s, l, h) {
							...
							if (g) {
								o.computeStackTrace.augmentStackTraceWithInitialElement(g, a, s, d), n();
							} else if (p && i.isError(p)) {
								e(o.computeStackTrace(p), !0);
							} else {
							...
							if (void 0 !== e.stack && e.stack) {
								for (var t, n, i, o = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|[a-z]:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, a = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx(?:-web)|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, s = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|moz-extension).*?:\/.*?|\[native code\]|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, u = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, l = /\((\S*)(?::(\d+))(?::(\d+))\)/, f = e.stack.split("\n"), h = [], p = (/^(.*) is undefined$/.exec(e.message), 0), d = f.length; p < d; ++p) {
									if (n = o.exec(f[p])) {
										...
										n[3] && n[3].indexOf(" > eval") > -1 && (t = u.exec(n[3])) ? (n[3] = t[1], n[4] = t[2], n[5] = null) : 0 !== p || n[5] || void 0 === e.columnNumber || (h[0].column = e.columnNumber + 1), i = {
											url: n[3],
											func: n[1] || c,
											args: n[2] ? n[2].split(",") : [],
											line: n[4] ? +n[4] : null,
						...
						function n(e, a) {
							for (var s, u, l = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, f = [], h = {}, p = !1, d = n.caller; d && !p; d = d.caller) {
								if (d !== i && d !== o.report) {
									if (u = {
										url: null,
										func: c,
										line: null,
										column: null,
									}, d.name ? u.func = d.name : (s = l.exec(d.toString())) && (u.func = s[1]), void 0 === u.func) {
										try {
	...
	var r, i, o = n(1);
	n(7);
	var a = n(3), s = !1, c = !0, u = o.DEFAULT_LANG, l = o.DEFAULT_SUB_TYPE;
	...
	function h(e, t, n) {
		if (i.readyState == WebSocket.OPEN) {
			...
			i.readyState == WebSocket.CONNECTING ? f(chrome.i18n.getMessage("WsIsConnecting")) : (f(chrome.i18n.getMessage("WsIsNotOpened")), y());
		}
	}

	a.config(o.PUBLIC_SENTRY_URL, {release: "1.2.0", environment: "prod", sampleRate: 1}).install();
	...
	function y() {
		...
		u == o.JA && (e = 12), (i = new WebSocket("ws://api.interpreter.caiyunai.com/v1/audio", ["subprotocols", `lang#${u}`, "if_interim_results#true", `trans_interval#${e}`, `token#${v}`, `app#${g}`])).onopen = function () {
			f(chrome.i18n.getMessage("wsIsOpened")), S = E, m || (r && (r.start(), f(chrome.i18n.getMessage("recording"))), m = !0);
		}, chrome.runtime.lastError, i.onmessage = function (e) {
			d(e.data);
		}, i.onerror = function (e) {
			f(chrome.i18n.getMessage("wsError")), function (e) {
	...
	var w = "", E = -1, S = -11, k = [], x = "cyxy-", R = `${x}video`;
	...
	function T(e, t, n) {
		if ("showSubByVideoBtn" == e.type) {
			chrome.tabs.query({active: !0, currentWindow: !0}, function (e) {
				...
				t.match(U) || (w = t, E = e[0].id, n = {
					...
					if (e) {
						...
						chrome.runtime.lastError.message.includes("permission") ? (alert(chrome.i18n.getMessage("requestReloadAndReload")), chrome.tabs.sendMessage(E, {type: "closeVideoBtn"})) : O(E);
					}
				}));
			});
		} else if ("closeSubByVideoBtn" == e.type) {
			chrome.tabs.sendMessage(E, {type: "closeSubtitle"}), ga("send", "event", R, e.type, u);
			...
			ga("send", "event", R, e.typ, e.newTrack);
		} else if ("clickCyxyBtn" == e.type) {
			q() ? ga("send", "event", `${x}${e.btnName}`, "click", "isLoggedIn") : ga("send", "event", `${x}${e.btnName}`, "click", "isUnlogin");
		} else if ("useDictAPI" == e.type || "useTranslatorAPI" == e.type) {
			M ? ga("send", "event", `${x}${e.type}`, `${e.direction}`, "isLoggedIn") : ga("send", "event", `${x}${e.type}`, `${e.direction}`, "isUnlogin");
		} else if ("audio" == e.type) {
			M ? ga("send", "event", `${x}${e.type}`, "read", "isLoggedIn") : ga("send", "event", `${x}${e.type}`, "read", "isUnlogin");
		} else if ("showSWTview" == e.type) {
			let t = B(e.direction);
			ga("send", "pageview", `${e.type}?utm_source=${t}&utm_medium=website`);
		} else {
			"optionsPageview" == e.type && ga("send", "pageview", "options");
		}
	}
	...
	function O(e) {
		!function (e, t) {
			e = e || (() => {
			...
			}), q() ? e() : fetch("https://biz.caiyunapp.com/test_cookies", {
				method: "GET",
				...
				if (r.cookies && r.cookies.cy_user) {
					...
					if (t.is_login) {
						return M = t._id, v = t.token, D = M, void e();
					}
				}
	...
	function _(e, t, n) {
		if ("fetchUrl" == e.contentScriptQuery) {
			const t = {};
			if (t.method = e.method || "GET", t.credentials = "include", t.headers = {"content-type": "application/json"}, e.data && (t.body = JSON.stringify(e.data)), e.headers) {
				var r = t.headers;
			...
			return fetch(e.url, t).then(e => e.text()).then(e => {
				...
				if (t.cookies && "" == M && t.cookies.cy_user) {
					...
					e.is_login && (M = e._id, v = e.token, D = M);
				}
			}).catch(e => {
	...
	function L(e) {
		"options" == e.tag && chrome.runtime.openOptionsPage();
	}
	...
	const U = "^(chrome://).+", C = "^(http(s)?://)?((w){3}.)?youtu(be|.be)?(.com)?/.+";
	...
	function N(e, t) {
		chrome.tabs.query({active: !0, currentWindow: !0}, function (n) {
			...
			let r = B(n[0].url);
			chrome.runtime.onMessage.hasListener(_) || chrome.runtime.onMessage.addListener(_), chrome.runtime.onMessage.hasListener(T) || chrome.runtime.onMessage.addListener(T), chrome.runtime.onMessage.hasListener(j) || chrome.runtime.onMessage.addListener(j), chrome.runtime.onMessage.hasListener(L) || chrome.runtime.onMessage.addListener(L), chrome.runtime.onMessage.hasListener(A) || chrome.runtime.onMessage.addListener(A), s && (chrome.tabs.executeScript(e, {
				file: "trs.js",
				runAt: t,
				...
				chrome.tabs.sendMessage(e, {type: "checkInserted", script: "sub"}, function (t) {
					chrome.runtime.lastError || !t ? async function (e) {
						try {
							await P(e, {file: "jquery.js"}), await async function (e) {
								let t = w.split("//");
								t = t.length >= 2 ? t[1].split("/")[0] : "";
								for (const n of o.DISTILLER_WHITE_LIST) {
									if (t.includes(n)) {
							...
							}(e), await P(e, {code: `var optionLang = "${u}", optionSubType = "${l}"`}), await P(e, {file: "sub.js"}), chrome.tabs.sendMessage(e, {type: "turnOnVideoBtn"});
						} catch (t) {
							chrome.tabs.sendMessage(e, {type: "alert", content: t, time: 5}), a.captureException(t);
						}
					}(e) : chrome.tabs.sendMessage(e, {type: "turnOnVideoBtn"});
				});
			}, 100), s = !1), c && (chrome.tabs.executeScript(e, {
				file: "swt.js",
				runAt: t,
	...
	function I() {
		chrome.permissions.contains({
			...
			e ? F() : chrome.permissions.request({
				permissions: ["webNavigation", "tabCapture"],
				origins: ["<all_urls>"],
			}, function (e) {
				e ? (F(), W()) : alert(chrome.i18n.getMessage("getAllUrlsFailed"));
			});
		}), chrome.permissions.contains({
			permissions: ["cookies"],
	...
	function F() {
		chrome.webNavigation.onHistoryStateUpdated.addListener(function (e) {
			0 === e.frameId && -1 != E && "" != w && chrome.tabs.get(e.tabId, function (e) {
				w.match(C) && e.id == E && e.url != w && (w = e.url, chrome.tabs.update(E, {url: w}));
			});
		}), chrome.webNavigation.onBeforeNavigate.addListener(function (e) {
			e.id == E && m && b(() => {
			});
		}), chrome.tabs.onRemoved.addListener(function (e, t) {
			e == S && i && (i.onclose = function () {
			}, i.close());
		});
	}
	...
	async function W(e) {
		await new Promise(function (e, t) {
			...
			if (chrome.cookies.get({url: "https://caiyunapp.com", name: "cy_user"}, function (t) {
				...
				if (D != i && (o = !0, M = i, v = r), D = i, chrome.runtime.lastError) {
					let e = chrome.runtime.lastError.message;
					a.captureException(e);
				}
				e([n, i, o]);
			...
			let t = e[0].url;
			t.match(U) || (w = t, N(E = e[0].id, "document_start"));
		});
	}

	chrome.browserAction.onClicked.addListener(function (e) {
		e.url.match("^(file:///).+(mp3|mp4|avi|flv|wmv|mov|html)$") && chrome.extension.isAllowedFileSchemeAccess(function (e) {
			if (!e) {
				return alert(chrome.i18n.getMessage("RequireAllowAccessFile")), void chrome.tabs.create({url: "chrome://extensions/?id=" + chrome.runtime.id});
			}
		}), main(e);
		...
		s = !0, chrome.storage.sync.get({
			...
			c = e.isAutoSWT, u = o.LANG_L[e.transDirect], l = o.SUB_TYPE_l[e.subType];
			var t = chrome.runtime.getManifest();
			e.isFirst && I(), e.version != t.version && setTimeout(function () {
			}, 3e4);
		}), W();
		...
		1 != (0 != e.frameId) && chrome.storage.sync.get({
			...
			c = t.isAutoSWT, u = o.LANG_L[t.transDirect], l = o.SUB_TYPE_l[t.subType], t.isAutoTranslate && (t.isAutoTranslate ? (chrome.browserAction.setBadgeText({text: "auto"}), chrome.browserAction.setBadgeBackgroundColor({color: "#5ebb8d"})) : chrome.browserAction.setBadgeText({text: ""}), chrome.tabs.detectLanguage(e.id, function (e) {
				s = !(!e.includes("en") && !e.includes("ja")), W();
			})), W();
		});
	});
	let D = "";
	...
	!function (e) {
		...
		i.IsOpen = function () {
			...
			if (e) {
				var t = e.getTracks();
				if (t.length > 0) {
					return "live" == t[0].readyState;
				}
			}
			return !1;
		}, o.prototype = {
			open: function (n, r) {
				if (n = n || t, r = r || t, i.IsOpen()) {
					n();
				} else {
				...
				var n = i.Stream;
				if (n) {
					for (var r = n.getTracks(), o = 0; o < r.length; o++) {
						r[o].stop();
					}
				}
				i.Stream = 0, e();
				...
				if (e.recSize = 0, e._stop(), e.state = 0, !i.IsOpen()) {
					return;
				}
				const o = i.Stream;
				...
				u.onaudioprocess = function (o) {
					if (1 == e.state) {
						...
						if (i.Ctx.sampleRate == e.set.sampleRate) {
							s = c;
						} else {
				...
				if (r.state) {
					...
					if (o) {
						...
						setTimeout(function () {
							Date.now(), r[i.type](a, function (t) {
								e(t, l);
							});
						});
					} else {
				...
				if (s > 1) {
					r = Math.floor(r / s);
					for (var c = new Int16Array(r), u = 0, l = 0; u < r;) {
						c[u] = e[l], l += s, u++;
					}
					e = c;
				} else {
				...
				if (m("RIFF"), v(36 + f), m("WAVE"), m("fmt "), v(16), g(1), g(1), v(i), v(i * (a / 8)), g(a / 8), g(a), m("data"), v(f), 8 == a) {
					for (u = 0; u < r; u++, d++) {
						var y = e[u];
	...
	function r(e, t, n, r) {
		if (this.fromSampleRate = +e, this.toSampleRate = +t, this.channels = 0 | n, "object" != typeof r) {
			throw new Error("inputBuffer is not an object.");
		}
		if (!(r instanceof Array || r instanceof Float32Array || r instanceof Float64Array)) {
	...
	Object.defineProperty(t, "__esModule", {value: !0}), t.Resampler = r, r.prototype.initialize = function () {
		...
		for (e += "}        weight -= 1;        for (bufferLength -= " + this.channels + ", sourceOffset = Math.floor(weight) * " + this.channels + "; sourceOffset < bufferLength;) {            secondWeight = weight % 1;            firstWeight = 1 - secondWeight;", t = 0; t < this.channels; ++t) {
			e += "outputBuffer[outputOffset++] = (buffer[sourceOffset" + (t > 0 ? " + " + t : "") + "] * firstWeight) + (buffer[sourceOffset + " + (this.channels + t) + "] * secondWeight);";
		}
		for (e += "weight += " + this.ratioWeight + ";            sourceOffset = Math.floor(weight) * " + this.channels + ";        }", t = 0; t < this.channels; ++t) {
		...
		for (var e = "var outputOffset = 0;    if (bufferLength > 0) {        var buffer = this.inputBuffer;        var weight = 0;", t = 0; t < this.channels; ++t) {
			e += "var output" + t + " = 0;";
		}
		for (e += "var actualPosition = 0;        var amountToNext = 0;        var alreadyProcessedTail = !this.tailExists;        this.tailExists = false;        var outputBuffer = this.outputBuffer;        var currentPosition = 0;        do {            if (alreadyProcessedTail) {                weight = " + this.ratioWeight + ";", t = 0; t < this.channels; ++t) {
			e += "output" + t + " = 0;";
		}
